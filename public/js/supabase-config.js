...
(function () {
  ...
  window.VeloraSupabase = {
    ...
    sendAdminEmailNotification(booking) {
      ...
      console.log("=================================================");
      console.log("REAL ADMIN GMAIL DISPATCH TO SERVERLESS API: /api/send-booking-email");
      console.log("Subject: New Room Booking - Velora Grand Hotel & Spa");
      console.log(JSON.stringify(payload, null, 2));
      console.log("=================================================");

      // 1. Call Vercel/Node Serverless API /api/send-booking-email
      ...
      .then(async res => {
        ...
        console.log("Server API Email Response:", data);
      })
      .catch(err => {
        console.warn("Server API Email dispatch note:", err);
      });
      ...
      }).catch(err => console.error("EmailJS fallback log:", err));
    },
